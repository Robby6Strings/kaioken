...
export const Modal: Kaioken.FC<ModalProps> = (props) => {
  ...
  return (
    <div
      ...
      role="dialog"
      popover="manual"
      className="w-full [&:popover-open]:grid [&:popover-open]:place-items-center min-h-screen bg-[black]/50"
    >
      <div
        className={twMerge(
          'p-400 w-full my-auto max-w-[31rem] bg-white rounded-xl',
          props.className
        )}
      >
        {props.children}
...
export const ModalTitle: Kaioken.FC<ModalTitleProps> = (props) => {
  return (
    <div className="w-full flex justify-between items-center">
      <h2 className="text-grey-900 text-preset-1 font-bold">{props.title}</h2>
      {props.onclose && (
