...
import { useKeyDown } from "$/hooks-mock/useKeyStroke"
import { useStartTyping } from "$/hooks-mock/useStartTyping"
...
export const CommandPalette: Kaioken.FC<{
  container: Kaioken.Ref<HTMLDivElement | null>
}> = (props) => {
  ...
  return (
    isClient && (
      <Portal container={document.body}>
        <div
          className="w-full h-screen fixed top-0 left-0 z-30 flex justify-center p-12 items-start bg-black/50"
